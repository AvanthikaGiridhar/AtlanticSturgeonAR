...
function show_warning(id) {
  setCSSRuleStyle('display', 'block', 'warning_message_div', false, '');
  setCSSRuleStyle('display', 'block', id, false, '');
  registerSetTimeout(1, function() {
    setCSSRuleStyle('display', 'none', 'warning_message_div', false, '');
    setCSSRuleStyle('display', 'none', id, false, '');
  });
}


changeVis(['GROUP', 'sturgeon'], true);
...
registerOnClick('body_mesh', false, false, [0,1,2], function() {
  playSound(loadMedia_WebAudio('./sounds/splash.mp3'), false);
}, function() {});

setShadowParam('body_mesh', 'CAST', 'ENABLE');

checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      changeVis(['GROUP', 'sturgeon'], false);
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], function() {
  changeVis(['GROUP', 'sturgeon'], true);
  setObjTransform('body_mesh', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
